...
import { TreeSelect, Card, Select } from 'antd';
import styles from './SideBar.module.scss';
import WaterQualityDistribution from "@components/sideBar/WaterQualityDistribution.jsx";
        ...
        <>
            <div className={`${styles.sidebar} ${false ? styles.collapsed : ''}`}>
                ...
                >
                    ...
                    {/* 水质饼图 */}
                    {/* 调整饼图大小并确保其与其它元素紧凑排列 */}
                    <WaterQualityDistribution data={mockData} style={{ height: '200px' }} />
